...
import { ChartBarIcon, CurrencyDollarIcon, UserGroupIcon, DocumentTextIcon, Bars3Icon, XMarkIcon, BoltIcon, WrenchIcon, SquaresPlusIcon } from '@heroicons/react/24/outline';
...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  const menuItems = [
    ...
    { id: 'tiles-labor', label: 'Tiles Labor', icon: SquaresPlusIcon },
  ];
